...
if __name__ == "__main__":
    problem, equation = "sally had 27 pokemon cards . dan gave her 41 new pokemon cards . sally bought 20 pokemon cards . How many pokemon cards does sally have now ? ", "x = 128 / 4"
    ...
    problem, equation = "edward bought 79 tickets at the state fair . he spent 23 tickets at the 'dunk a clown ' booth and decided to use the rest on rides . if each ride cost 7 tickets how many rides could he go on ?", "x = / 79  23 7"
    problem_tuple = NumberTag(problem, equation)
